...
# Tamaño de la ventana, SE MODIFICÓ porque no coincidía el tamaño 
...
# Etiqueta titulo -> se tuvo que modificar el tamaño, ya que no centraba
etiqueta_titulo = Label(panel_superior, text='Sistema de Facturacion', fg='white',
                        font=('Dosis', 58), bg='orange', width=23)
...
# panel calculadora
panel_calculadora = Frame(panel_derecha, bd=1, relief=FLAT, bg='orange')
panel_calculadora.pack()

# panel recibo
panel_recibo = Frame(panel_derecha, bd=1, relief=FLAT, bg='orange')
panel_recibo.pack()

# panel botones
panel_botones = Frame(panel_derecha, bd=1, relief=FLAT, bg='orange')
panel_botones.pack()
...
#Botones, se tuvo que cambiar el tamaño de los botones porque no coincidia
botones = ['total', 'recibo', 'guardar', 'resetear']
botones_creados = []

columnas = 0
for boton in botones:
    boton = Button(panel_botones,text=boton.title(),font=('Dosis', 14, 'bold'),fg='white',bg='azure4',bd=1,width=7)
...
#Escribir los botones tipo calculadora
