...
def transformar_audio_en_texto():
    ...
    with sr.Microphone() as origen:
        ...
        #Tiempo de espera para que comience a escuchar
        ...
        try:
            ...
            #Prueba de imprimir en pantalla
        ...
        #En caso de no comprender el audio    
            ...
            print("Uups, No comprendí el audio")
...
def saludo_inicial():
    ...
    #Decir el saludo
    hablar(f"{momento}, Hola qué tal. Soy Helena, tu asistente personal. Por favor, dime que te puedo ayudar")
...
def pedir_cosas():
    ...
    while comenzar:
        ...
        elif 'abrirnavegador' in pedido:
            hablar('Con gusto, estoy abriendo Google Chrome')
